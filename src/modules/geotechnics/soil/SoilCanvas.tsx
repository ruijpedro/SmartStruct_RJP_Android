...
export function SoilCanvas({ input }: { input: Input }) {
  return (
    <svg viewBox="0 0 360 220" role="img" aria-label="Esquema Solos" style={{ width: '100%', maxWidth: 520, border: '1px solid #d8e1e8', borderRadius: 12, background: '#fff' }}>
      ...
      <text x="24" y="30" fontSize="16" fill="#173447" fontWeight="700">Solos</text>
